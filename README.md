...
- `frontend/` : 프론트엔드 팀 작업 공간 (사용자 인터페이스 및 클라이언트 로직)
- `backend/` : 백엔드 팀 작업 공간 (서버, 데이터베이스, 3D 모델링, API 로직)
...
원활한 협업을 위해 다음 규칙을 지켜주세요. (팀 내 협의 후 아래 내용을 수정하여 사용하세요)

### 브랜치 전략 (Branch Strategy)
* `main`: 배포 가능한 안정적인 코드가 모이는 브랜치입니다.
* `frontend/feat/...`: 프론트엔드 기능 개발 브랜치입니다.
* `backend/feat/...`: 백엔드 기능 개발 브랜치입니다.